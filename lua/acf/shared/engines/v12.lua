...
ACF_DefineEngine( "4.6-V12", {
	...
	desc = "An elderly racecar engine; low on torque, but has plenty of power",
...
ACF_DefineEngine( "7.0-V12", {
	...
	desc = "A high end V12; found primarily in very expensive cars",
...
ACF_DefineEngine( "4.0-V12", {
	...
	desc = "Reliable truck-duty diesel; plenty of smooth torque",
	model = "models/engines/v12s.mdl",
...
ACF_DefineEngine( "9.2-V12", {
	...
	desc = "High torque light-tank V12; mainly for vehicles that require balls",
	model = "models/engines/v12m.mdl",
...
ACF_DefineEngine( "21.0-V12", {
	...
	desc = "AVDS-1790-2 tank engine; extremely powerful, but enormous and heavy",
	model = "models/engines/v12l.mdl",
